...
set "TMP_PS1=%TEMP%\altair-install-%RANDOM%.ps1"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Invoke-WebRequest -Uri '%PS1_URL%' -OutFile '%TMP_PS1%' -UseBasicParsing"
if errorlevel 1 (
